...
for p in paths:
    ...
    ## plot
    g = sns.catplot(data=mat_df_long, kind="violin",palette=["#4682B4", "#CDC9C9"],
    ...
    g.set_ylabels('H3K27me3 (Gene set - Control)')

    g.fig.suptitle(f'{p}', y=1.02, fontsize=12)

    plt.savefig(f'{p}_cprdiff_tss_central4.8kbp_k27me3.pdf', bbox_inches='tight')
    plt.close()