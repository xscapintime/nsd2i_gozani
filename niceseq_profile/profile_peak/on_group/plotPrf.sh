...
do
	...
	plotHeatmap -m $f -o $bn.png --colorMap RdBu_r --samplesLabel $samples --regionsLabel $bedlist  --xAxisLabel "peak" --missingDataColor "#FFF6EB"  #--yMin $min --yMax $max --zMax $hmax
